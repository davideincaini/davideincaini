...
| Project | Description | Stack |
|---|---|---|
| [Credit Scoring](https://github.com/davideincaini/credit-scoring-ml) | Binary classification on 338k records — SMOTE, sklearn Pipeline, SHAP interpretability for rejection motivation | Python |
| [Insurance Cross-Selling](https://github.com/davideincaini/insurance-cross-selling) | Propensity model for vehicle insurance upsell — statistical feature selection, logistic regression baseline | Python |
...
*I care about code that solves real problems — not just code that runs.*
